(() => {
  ...
  function renderMyPage(){
    ...
    a.innerHTML=`<div class="myHero"><div class="myAvatar">😊</div><div><span class="myHello">こんにちは</span><h2>${esc(p.nickname)}さん</h2></div></div>
      ...
      <details class="myHow remoteHelp"><summary>📦 遠隔スタンプラリーって？ <small>説明を見る</small></summary><div class="remoteHelpBody"><p><b>遠方購入でもスタンプがもらえます。</b></p><p>① 商品・サービスを購入<br>② お店へ参加IDを伝える<br>③ お店が購入確認後、遠隔でスタンプを付与</p><p>お客様自身でスタンプを押す必要はありません。お店が付与すると、マイページのスタンプに反映されます。</p></div></details>
